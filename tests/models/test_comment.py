...
import mocker
import datetime
from stalker.models import comment, entity, user, tag
...
class CommentTest(mocker.MockerTestCase):
    ...
    #----------------------------------------------------------------------
    def test_body_attribute_empty(self):
        """testing if everythings will be ok if body attribute is set to
        nothing
        """
    ...
    def test_to_attribute_being_none(self):
        """testing if a ValueError will be raised if to **attribute** is tried
        to be set to None
        """
        
        # create a new comment with no to attribute
    ...
    def test_to_attribute_being_set_to_other_than_entity(self):
        """testing if a ValueError will be raised if **to** **atribute** tried
    ...
    #----------------------------------------------------------------------
    def test_to_attribute_being_skipped(self):
        """testing if a ValueError will be raised if **to** **atribute** is
        skipped
        """
