...
from stalker import (defaults, Studio, WorkingHours, Project, StatusList,
                     Status, Repository, Asset, Type, User, Shot, Department, Task, TaskJugglerScheduler)
...
class StudioTester(unittest2.TestCase):
    ...
    def test_schedule_will_schedule_the_tasks_with_the_given_scheduler(self):
        ...
        #def printer(entity, var_name):
        #    print '# %s' % var_name
        #    if entity.computed_start:
        #        print 'self.assertEqual('
        #        print '    %s.computed_start,' % var_name
        #        print '    datetime.datetime(%s)' % (entity.computed_start.strftime('%Y, %m, %d, %H, %M'))
        #        print ')'
        #        
        #        print 'self.assertEqual('
        #        print '    %s.computed_end,' % var_name
        #        print '    datetime.datetime(%s)' % (entity.computed_end.strftime('%Y, %m, %d, %H, %M'))
        #        print ')'
        #    else:
        #        print 'self.assertIsNone(%s.computed_start)' % var_name
        #        print 'self.assertIsNone(%s.computed_end)' % var_name
        #    print ''
        #
        #printer(self.test_asset1, 'self.test_asset1')
        #printer(self.test_asset2, 'self.test_asset2')
        #printer(self.test_shot1, 'self.test_shot1')
        #printer(self.test_shot2, 'self.test_shot2')
        #printer(self.test_shot3, 'self.test_shot3')
        #printer(self.test_shot4, 'self.test_shot4')
        #printer(self.test_shot5, 'self.test_shot5')
        #printer(self.test_task1, 'self.test_task1')
        #printer(self.test_task2, 'self.test_task2')
        #printer(self.test_task3, 'self.test_task3')
        #printer(self.test_task4, 'self.test_task4')
        #printer(self.test_task5, 'self.test_task5')
        #printer(self.test_task6, 'self.test_task6')
        #printer(self.test_task7, 'self.test_task7')
        #printer(self.test_task8, 'self.test_task8')
        #printer(self.test_task9, 'self.test_task9')
        #printer(self.test_task10, 'self.test_task10')
        #printer(self.test_task11, 'self.test_task11')
        #printer(self.test_task12, 'self.test_task12')
        #printer(self.test_task13, 'self.test_task13')
        #printer(self.test_task14, 'self.test_task14')
        #printer(self.test_task15, 'self.test_task15')
        #printer(self.test_task16, 'self.test_task16')
        #printer(self.test_task17, 'self.test_task17')
        #printer(self.test_task18, 'self.test_task18')
        #printer(self.test_task19, 'self.test_task19')
        #printer(self.test_task20, 'self.test_task20')
        #printer(self.test_task21, 'self.test_task21')
        #printer(self.test_task22, 'self.test_task22')
        #printer(self.test_task23, 'self.test_task23')
        #printer(self.test_task24, 'self.test_task24')
        #printer(self.test_task25, 'self.test_task25')
        #printer(self.test_task26, 'self.test_task26')
        #printer(self.test_task27, 'self.test_task27')
        #printer(self.test_task28, 'self.test_task28')
        #printer(self.test_task29, 'self.test_task29')
        #printer(self.test_task30, 'self.test_task30')
        #printer(self.test_task31, 'self.test_task31')
