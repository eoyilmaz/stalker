...
import unittest
from stalker import Entity, Review, User
...
class ReviewTest(unittest.TestCase):
    ...
    def test_body_argument_being_empty(self):
        """testing if everything will be ok if body argument is set to
        nothing
        """
    ...
    def test_to_attribute_doesnt_accept_everything(self):
        ...
        tried to be set to something that has no "reviews" attribute
        """
