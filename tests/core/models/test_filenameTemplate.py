...
class FilenameTemplateTester(unittest.TestCase):
    ...
    def test_output_path_code_argument_is_None_and_output_is_relative_is_true_will_set_the_output_path_code_attribute_to_empty_string(
    self):
    ...
    def test_output_path_code_argument_is_empty_string_and_output_is_relative_is_true_will_set_the_output_path_code_attribute_to_empty_string(
    self):
        """testing if the output_path_code argument is None will set the
        output_path attribute to empty string
        """
    ...
    def test_output_file_code_argument_is_None_and_output_is_relative_is_true_will_set_the_output_path_attribute_to_empty_string(
    self):
    ...
    def test_output_file_code_argument_is_empty_string_and_output_is_relative_is_true_will_set_the_output_file_code_attribute_to_empty_string(
    self):
        """testing if the output_file_code argument is None will set the
