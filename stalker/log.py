...
def set_level(level):
    ...
    Args:
        level (int): The logging level. The value should be valid with the logging
        library and should be one of [NOTSET, DEBUG, INFO, WARN, WARNING, ERROR, FATAL,
        CRITICAL] of the logging library (or anything that is registered as a proper
        logging level).
